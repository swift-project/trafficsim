/**
	...
	<!-- Copyright © 2012-2013 Gary Tekulsky 1134195. All rights reserved. -->
	@copyright Copyright &copy; 2012-2013 Gary Tekulsky 1134195. All rights reserved.
*/
...
/*
	...
	It is recommended that one of the following two methods is used to handle calls to the VATSIM library to deal with the threading limitations:
	   1. Always call library functions from the main thread. The libraries functions do not block, so the program simply needs to call them with adequate frequency
	   2. Always call library functions from a single worker thread and use some kind of synchronizing structure, such as a message queue, to send commands to the library worker
...
/**
	...
	@brief Contains functions and variables for the network library
*/
...
public:
	...
	*/
	...
	/*
		********************************
		* SETUP AND HANDLING FUNCTIONS *
		********************************
	*/
	/**
		@name Setup and Handling Functions
	*/
	///@{
	...
	*/
	...
	/**
		Attempts to connect to the server and start the authentication/login process. This function should not be invoked unless login information has been specified by
	...
	*/
	...
	/**
		Calling this function makes the library do all of the work. If this function is not called nothing will happen. The program should call this at least every 100ms
	...
	*/
	/**
		@name Basic Communications Functions
	*/
	///@{
	...
	*/
	...
	/**
		...
		@note This function should be used in-between regular position updates only. eg. When doing a 1 Hz update rate the program should
	...
	*/
	...
	/**
		Pings a user or usergroup. All clients may use this function but only admins or supervisors may use the all ATC/everyone callsigns
	...
	*/
	...
	/**
		Sends a pong in response to a ping. All clients may use this function to respond to a ping
	...
	*/
	/**
		@name Callback Registration Functions
	*/
	///@{

	/**
		Installs the onConnectionStatusChangedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onTextMessageReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onRadioMessageReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPilotDisconnectedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onControllerDisconnectedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPilotPositionUpdateEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onInterimPilotPositionUpdateEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onAtcPositionUpdateEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onKickedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPongEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onFlightPlanReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onHandoffRequestReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onHandoffAcceptedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onHandoffCancelledRejectedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onMetarReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onInfoQueryRequestReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onInfoQueryReplyReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onCapabilitiesReplyReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onAtisReplyReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onTemperatureDataReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onErrorReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onWindDataReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onCloudDataReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPilotInfoRequestReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPilotInfoReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onSharedStateReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onLandlineCommandReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onTrackingCommandReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onBreakCommandReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onSharedStateIDRequestReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onSharedStateIDReplyReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onPushStripReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
	...
	*/
	...
	/**
		Installs the onHelpRequestReceivedEvent callback. The program can only install 1 of these. Calling this function again will replace the existing function
...
/**
	...
	@brief Contains functions and variables for the simple implementation of the voice library. This is most suitable for a pilot client
...
public:
	...
	*/
	...
	/*
		*******************************
		* ROOM AND HANDLING FUNCTIONS *
		*******************************
	*/
	/**
		@name Room and Handling Functions
	*/
	///@{
	...
	*/
	...
	/**
		...
		@param[in] roomIndex Which room index to associate the room with. Valid values are between 0 (inclusive) and the value of roomCount (exclusive) from the Setup function
		...
		@note LeaveRoom should be executed before rejoining a room. If this is not done this function will perform an abortive and disorderly disconnect on the old room
		@note The roomStatusUpdate_JoinFail message is not sent if this function returns false
		@note When this function returns true, it only means that the neccessary requirements to ATTEMPT the room join were met, if a failure occurs during the actual joining
	...
	*/
	...
	/**
		...
		@param[in] roomIndex Which room index to leave. Valid values are between 0 (inclusive) and the value of roomCount (exclusive) from the Setup function
	...
	*/
	...
	/**
		...
		@param[in] roomIndex Which room index to set the state on. Valid values are between 0 (inclusive) and the value of roomCount (exclusive) from the Setup function
	...
	*/
	...
	/**
		...
		@param[in] roomIndex Which room index to check. Valid values are between 0 (inclusive) and the value of roomCount (exclusive) from the Setup function
	...
	*/
	...
	/**
		Calling this function makes the library do all of the work. If this function is not called, nothing will happen. This should be called at least every 100ms
	...
	*/
	...
	/**
		...
		@note The callback function does not provide a way to distinguish which room the result is being returned for, this function should only be running one at a time or
	...
	*/
	...
	/**
		...
		@param[in] roomIndex Which room index to set. Valid values are between 0 (inclusive) and the value of roomCount (exclusive) from the Setup function
		@param[in] outputIndex Which output index to set. Valid values are between 0 (inclusive) and the value of outputCount (exclusive) from the Setup function
		...
		@throws RoomNotConnectedException Thrown if this method is called with a room that isn't connected
	*/
	VM void CALL SetOutoutState(INT roomIndex, INT outputIndex, bool isOn)PVM;
	...
	*/
	/**
		@name Audio Hardware Management Functions
	*/
	///@{
	...
	/**
		...
		@note The callback function does not provide a way to distinguish if it is returning for inputs or outputs, there should only be one of these functions running at a time
	...
	*/
	/**
		@name Mic Test Wizard Functions
	*/
	///@{
	...
	*/
	...
	/**
		Plays the audio recorded during the record test. This routine automatically uses the last recorded stream. This function does not monitor when playback is completed so
	...
	*/
	...
	/**
		Use this function to set the microphone squelch. This can be used to change it manually or to restore a saved setting. The value is a binary representation of peak
	...
	*/
	...
	/**
		Use this function to set the output squelch. This can be used to change it manually or to restore a saved setting. The value is a binary representation of peak
